/* Generated by bootstrap/native-c.omg from calculator.omgb */
...
static Value v_calc;
static Value v_b;
static Value v_module_file;
static Value v_r;
static Value v_args;
static Value v_parse_num;
static Value v_op;
static Value v_current_dir;

static Value omg_p0(Value *, int, int, Value, Value, Value, Value, Value, Value, Value, Value);
static Value omg_p1(Value *, int, int, Value, Value, Value, Value, Value, Value, Value, Value);

static OmgFn omg_lookup_fn(const char *name);

static Value omg_p0(Value *captured, int cap_count, int argc,
                            Value omg_a0, Value omg_a1, Value omg_a2, Value omg_a3,
                            Value omg_a4, Value omg_a5, Value omg_a6, Value omg_a7) {
    (void)cap_count; (void)argc;
    Value stack[256];
    int sp = 0;
    (void)stack; (void)sp;
    (void)captured;
    ...
    Value v_op = omg_a1;
    Value v_b = omg_a2;
    { Value v = v_op; omg_inc(v); stack[sp++] = v; }
    stack[sp++] = omg_str("+");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0164; }
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_a);
        omg_dec(v_op);
...
L0164:;
    ...
    stack[sp++] = omg_str("-");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0173; }
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_sub(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_a);
        omg_dec(v_op);
...
L0173:;
    ...
    stack[sp++] = omg_str("*");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0182; }
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_mul(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_a);
        omg_dec(v_op);
...
L0182:;
    ...
    stack[sp++] = omg_str("/");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0191; }
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_div(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_a);
        omg_dec(v_op);
...
L0191:;
    ...
    stack[sp++] = omg_str("%");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0200; }
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_mod(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_a);
        omg_dec(v_op);
...
L0200:;
    ...
    stack[sp++] = omg_str("//");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0209; }
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_floor_div(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_a);
        omg_dec(v_op);
...
L0209:;
    ...
    stack[sp++] = omg_str("**");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0218; }
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_builtin_pow(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_a);
        omg_dec(v_op);
    ...
    goto L0218;
L0218:;
    stack[sp++] = omg_str("unknown operator: '");
    { Value v = v_op; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    stack[sp++] = omg_str("' (try + - * / % // **)");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value m = stack[--sp]; omg_raise(0, m); }
    omg_dec(stack[--sp]);
    stack[sp++] = omg_none();
    {
        Value rv = stack[--sp];
...
static Value omg_p1(Value *captured, int cap_count, int argc,
                            Value omg_a0, Value omg_a1, Value omg_a2, Value omg_a3,
                            Value omg_a4, Value omg_a5, Value omg_a6, Value omg_a7) {
    (void)cap_count; (void)argc;
    Value stack[256];
    ...
    Value v_i = omg_none();
    Value v_n = omg_none();
    Value v_has_dot = omg_none();
    stack[sp++] = omg_int(0LL);
    omg_assign(&v_i, stack[--sp]);
    { Value v = v_s; omg_inc(v); stack[sp++] = v; }
    { Value v = stack[--sp]; Value r = omg_length(v); omg_dec(v); stack[sp++] = r; }
    omg_assign(&v_n, stack[--sp]);
    stack[sp++] = omg_bool(0);
    omg_assign(&v_has_dot, stack[--sp]);
L0105:;
    { Value v = v_i; omg_inc(v); stack[sp++] = v; }
    { Value v = v_n; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_lt(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0144; }
    { Value v = v_s; omg_inc(v); stack[sp++] = v; }
    { Value v = v_i; omg_inc(v); stack[sp++] = v; }
    { Value idx = stack[--sp]; Value base = stack[--sp]; Value r = omg_index(base, idx); omg_dec(idx); omg_dec(base); stack[sp++] = r; }
    stack[sp++] = omg_str(".");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0117; }
    stack[sp++] = omg_bool(1);
    goto L0124;
L0117:;
    { Value v = v_s; omg_inc(v); stack[sp++] = v; }
    ...
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_eq(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    stack[sp++] = omg_bool(0);
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_or(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
L0124:;
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0127; }
    stack[sp++] = omg_bool(1);
    goto L0134;
L0127:;
    { Value v = v_s; omg_inc(v); stack[sp++] = v; }
    ...
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_or(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
L0134:;
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0139; }
    stack[sp++] = omg_bool(1);
    omg_assign(&v_has_dot, stack[--sp]);
    goto L0144;
    goto L0139;
L0139:;
    { Value v = v_i; omg_inc(v); stack[sp++] = v; }
    stack[sp++] = omg_int(1LL);
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    omg_assign(&v_i, stack[--sp]);
    goto L0105;
L0144:;
    { Value v = v_has_dot; omg_inc(v); stack[sp++] = v; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0150; }
    { Value v = v_s; omg_inc(v); stack[sp++] = v; }
    { Value v = stack[--sp]; Value r = omg_builtin_float(v); omg_dec(v); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_s);
        omg_dec(v_i);
...
L0150:;
    { Value v = v_s; omg_inc(v); stack[sp++] = v; }
    { Value v = stack[--sp]; Value r = omg_builtin_int(v); omg_dec(v); stack[sp++] = r; }
    {
        Value rv = stack[--sp];
        omg_dec(v_s);
        omg_dec(v_i);
...
static const struct { const char *name; OmgFn fn; } omg_func_table[] = {
    {"calc", omg_p0},
    {"parse_num", omg_p1},
    {NULL, NULL}
};
static OmgFn omg_lookup_fn(const char *name) {
    for (int i = 0; omg_func_table[i].name; i++) {
        if (strcmp(omg_func_table[i].name, name) == 0) return omg_func_table[i].fn;
    }
    return NULL;
}
...
int main(int argc, char **argv) {
    (void)argc; (void)argv;
    /* Force line-buffered stdout so stdout/stderr interleave the
     * way Rust's stdio does (Rust's println! flushes on \n via
     * LineWriter even when piped). Matters for error tests where a
     * panic to stderr must come AFTER prior emits, not before. */
    setvbuf(stdout, NULL, _IOLBF, 0);
    Value stack[1024];
    int sp = 0;
    (void)stack; (void)sp;
    {
        char *cwdbuf = (char *)malloc(4096);
        if (cwdbuf && getcwd(cwdbuf, 4096)) {
            omg_cwd_str = cwdbuf;
        } else {
            free(cwdbuf);
            omg_cwd_str = ".";
    ...
    v_module_file = omg_str(argc > 0 ? argv[0] : "<stdin>");
    v_current_dir = omg_str(omg_cwd_str);
    {
        Value alist; alist.tag = OMG_LIST; alist.v.l = omg_list_alloc(argc);
        for (int i = 0; i < argc; i++) omg_list_push(alist.v.l, omg_str(argv[i]));
        v_args = alist;
    }

    omg_assign(&v_parse_num, omg_closure(omg_p1, NULL, 0));
    omg_assign(&v_calc, omg_closure(omg_p0, NULL, 0));
    { Value v = v_args; omg_inc(v); stack[sp++] = v; }
    { Value v = stack[--sp]; Value r = omg_length(v); omg_dec(v); stack[sp++] = r; }
    stack[sp++] = omg_int(4LL);
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_lt(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; int t = omg_truthy(v); omg_dec(v); if (!t) goto L0062; }
    stack[sp++] = omg_str("usage: ");
    { Value v = v_args; omg_inc(v); stack[sp++] = v; }
    stack[sp++] = omg_int(0LL);
    { Value idx = stack[--sp]; Value base = stack[--sp]; Value r = omg_index(base, idx); omg_dec(idx); omg_dec(base); stack[sp++] = r; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    stack[sp++] = omg_str(" <a> <op> <b>");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; omg_emit(v); omg_dec(v); }
    stack[sp++] = omg_str("ops:   + - * / % // **");
    { Value v = stack[--sp]; omg_emit(v); omg_dec(v); }
    stack[sp++] = omg_str("");
    { Value v = stack[--sp]; omg_emit(v); omg_dec(v); }
    stack[sp++] = omg_str("examples:");
    { Value v = stack[--sp]; omg_emit(v); omg_dec(v); }
    stack[sp++] = omg_str("  ");
    { Value v = v_args; omg_inc(v); stack[sp++] = v; }
    stack[sp++] = omg_int(0LL);
...
L0062:;
    ...
    { Value idx = stack[--sp]; Value base = stack[--sp]; Value r = omg_index(base, idx); omg_dec(idx); omg_dec(base); stack[sp++] = r; }
    {
        Value omg_a0 = stack[--sp];
        stack[sp++] = omg_p1(NULL, 0, 1, omg_a0, omg_none(), omg_none(), omg_none(), omg_none(), omg_none(), omg_none(), omg_none());
    }
    omg_assign(&v_a, stack[--sp]);
    { Value v = v_args; omg_inc(v); stack[sp++] = v; }
    stack[sp++] = omg_int(2LL);
    { Value idx = stack[--sp]; Value base = stack[--sp]; Value r = omg_index(base, idx); omg_dec(idx); omg_dec(base); stack[sp++] = r; }
    omg_assign(&v_op, stack[--sp]);
    { Value v = v_args; omg_inc(v); stack[sp++] = v; }
    stack[sp++] = omg_int(3LL);
    { Value idx = stack[--sp]; Value base = stack[--sp]; Value r = omg_index(base, idx); omg_dec(idx); omg_dec(base); stack[sp++] = r; }
    {
        Value omg_a0 = stack[--sp];
        stack[sp++] = omg_p1(NULL, 0, 1, omg_a0, omg_none(), omg_none(), omg_none(), omg_none(), omg_none(), omg_none(), omg_none());
    }
    omg_assign(&v_b, stack[--sp]);
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value v = v_op; omg_inc(v); stack[sp++] = v; }
    { Value v = v_b; omg_inc(v); stack[sp++] = v; }
    {
        Value omg_a2 = stack[--sp];
        Value omg_a1 = stack[--sp];
        Value omg_a0 = stack[--sp];
        stack[sp++] = omg_p0(NULL, 0, 3, omg_a0, omg_a1, omg_a2, omg_none(), omg_none(), omg_none(), omg_none(), omg_none());
    }
    omg_assign(&v_r, stack[--sp]);
    stack[sp++] = omg_str("");
    { Value v = v_a; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    stack[sp++] = omg_str(" ");
    ...
    stack[sp++] = omg_str(" = ");
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = v_r; omg_inc(v); stack[sp++] = v; }
    { Value b = stack[--sp]; Value a = stack[--sp]; Value r = omg_add(a, b); omg_dec(a); omg_dec(b); stack[sp++] = r; }
    { Value v = stack[--sp]; omg_emit(v); omg_dec(v); }
L0097:;
    return 0;
